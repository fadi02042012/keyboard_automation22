...
class _AutomationHomePageState extends State<AutomationHomePage> {
  ...
  final Map<String, Shortcut> _shortcuts = {
    ...
    'حفظ باسم (Ctrl+Shift+S)': Shortcut(key: 'S', modifiers: ['CTRL', 'SHIFT'], description: 'حفظ باسم'),
    'إغلاق النافذة (Alt+F4)': Shortcut(key: 'F4', modifiers: ['ALT'], description: 'إغلاق النافذة'),
    'إغلاق التبويب (Ctrl+W)': Shortcut(key: 'W', modifiers: ['CTRL'], description: 'إغلاق التبويب'),
    'فتح تبويب جديد (Ctrl+T)': Shortcut(key: 'T', modifiers: ['CTRL'], description: 'فتح تبويب جديد'),
    'إعادة فتح التبويب (Ctrl+Shift+T)': Shortcut(key: 'T', modifiers: ['CTRL', 'SHIFT'], description: 'إعادة فتح آخر تبويب مغلق'),
    'التبديل بين التبويبات التالي (Ctrl+Tab)': Shortcut(key: 'TAB', modifiers: ['CTRL'], description: 'التبويب التالي'),
    'التبديل بين التبويبات السابق (Ctrl+Shift+Tab)': Shortcut(key: 'TAB', modifiers: ['CTRL', 'SHIFT'], description: 'التبويب السابق'),
    'انتقال إلى بداية المستند (Ctrl+Home)': Shortcut(key: 'HOME', modifiers: ['CTRL'], description: 'بداية المستند'),
    'انتقال إلى نهاية المستند (Ctrl+End)': Shortcut(key: 'END', modifiers: ['CTRL'], description: 'نهاية المستند'),
    'صفحة لأعلى (PageUp)': Shortcut(key: 'PAGEUP', modifiers: [], description: 'صفحة لأعلى'),
    'صفحة لأسفل (PageDown)': Shortcut(key: 'PAGEDOWN', modifiers: [], description: 'صفحة لأسفل'),
    'حذف كلمة للخلف (Ctrl+Backspace)': Shortcut(key: 'BACKSPACE', modifiers: ['CTRL'], description: 'حذف الكلمة السابقة'),
    'حذف كلمة للأمام (Ctrl+Delete)': Shortcut(key: 'DELETE', modifiers: ['CTRL'], description: 'حذف الكلمة التالية'),
    'تحديد كلمة/جزء للأعلى (Ctrl+Shift+Up)': Shortcut(key: 'UP', modifiers: ['CTRL', 'SHIFT'], description: 'تحديد للأعلى'),
    'تحديد كلمة/جزء للأسفل (Ctrl+Shift+Down)': Shortcut(key: 'DOWN', modifiers: ['CTRL', 'SHIFT'], description: 'تحديد للأسفل'),
    'تحديد كلمة لليسار (Ctrl+Shift+Left)': Shortcut(key: 'LEFT', modifiers: ['CTRL', 'SHIFT'], description: 'تحديد كلمة لليسار'),
    'تحديد كلمة لليمين (Ctrl+Shift+Right)': Shortcut(key: 'RIGHT', modifiers: ['CTRL', 'SHIFT'], description: 'تحديد كلمة لليمين'),
    'الانتقال كلمة لليسار (Ctrl+Left)': Shortcut(key: 'LEFT', modifiers: ['CTRL'], description: 'انتقال كلمة لليسار'),
    'الانتقال كلمة لليمين (Ctrl+Right)': Shortcut(key: 'RIGHT', modifiers: ['CTRL'], description: 'انتقال كلمة لليمين'),
    'تحديد من الموضع إلى البداية (Ctrl+Shift+Home)': Shortcut(key: 'HOME', modifiers: ['CTRL', 'SHIFT'], description: 'تحديد إلى بداية المستند'),
    'تحديد من الموضع إلى النهاية (Ctrl+Shift+End)': Shortcut(key: 'END', modifiers: ['CTRL', 'SHIFT'], description: 'تحديد إلى نهاية المستند'),
    'إظهار سطح المكتب (Win+D)': Shortcut(key: 'D', modifiers: ['WIN'], description: 'إظهار/إخفاء سطح المكتب'),
    'قائمة الروابط السريعة (Win+X)': Shortcut(key: 'X', modifiers: ['WIN'], description: 'قائمة Windows السريعة'),
    'البحث في Windows (Win+S)': Shortcut(key: 'S', modifiers: ['WIN'], description: 'بحث Windows'),
    'التبديل بين التطبيقات (Alt+Tab)': Shortcut(key: 'TAB', modifiers: ['ALT'], description: 'التبديل بين التطبيقات'),
    'التبديل العكسي بين التطبيقات (Alt+Shift+Tab)': Shortcut(key: 'TAB', modifiers: ['ALT', 'SHIFT'], description: 'التبديل العكسي بين التطبيقات'),
    'إظهار كل النوافذ (Win+Tab)': Shortcut(key: 'TAB', modifiers: ['WIN'], description: 'عرض المهام'),
    'فتح الحافظة (Win+V)': Shortcut(key: 'V', modifiers: ['WIN'], description: 'سجل الحافظة'),
    'قفل الشاشة (Win+L)': Shortcut(key: 'L', modifiers: ['WIN'], description: 'قفل Windows'),
    'فتح الإشعارات (Win+N)': Shortcut(key: 'N', modifiers: ['WIN'], description: 'الإشعارات'),
    'فتح الإعدادات السريعة (Win+A)': Shortcut(key: 'A', modifiers: ['WIN'], description: 'الإعدادات السريعة'),
    'فتح البحث (Ctrl+E)': Shortcut(key: 'E', modifiers: ['CTRL'], description: 'البحث/التركيز على البحث'),
    'تحديث (Ctrl+R)': Shortcut(key: 'R', modifiers: ['CTRL'], description: 'تحديث الصفحة'),
    'تحديث قوي (Ctrl+Shift+R)': Shortcut(key: 'R', modifiers: ['CTRL', 'SHIFT'], description: 'تحديث قوي'),
    'فتح الرابط في تبويب جديد (Ctrl+Enter)': Shortcut(key: 'ENTER', modifiers: ['CTRL'], description: 'فتح/إكمال في تبويب جديد'),
    'الانتقال إلى شريط العنوان (Ctrl+L)': Shortcut(key: 'L', modifiers: ['CTRL'], description: 'شريط العنوان'),
    'تكبير العرض (Ctrl++)': Shortcut(key: 'ADD', modifiers: ['CTRL'], description: 'تكبير العرض'),
    'تصغير العرض (Ctrl+-)': Shortcut(key: 'SUBTRACT', modifiers: ['CTRL'], description: 'تصغير العرض'),
    'إعادة حجم العرض (Ctrl+0)': Shortcut(key: '0', modifiers: ['CTRL'], description: 'إعادة حجم العرض'),
    'فتح مدير المهام (Ctrl+Shift+Esc)': Shortcut(key: 'ESC', modifiers: ['CTRL', 'SHIFT'], description: 'مدير المهام'),
    'فتح قائمة الأمان (Ctrl+Alt+Delete)': Shortcut(key: 'DELETE', modifiers: ['CTRL', 'ALT'], description: 'قائمة أمان Windows'),
    'فتح مستكشف الملفات (Win+E)': Shortcut(key: 'E', modifiers: ['WIN'], description: 'مستكشف الملفات'),
    'فتح Run (Win+R)': Shortcut(key: 'R', modifiers: ['WIN'], description: 'تشغيل أمر'),
    'فتح إعدادات Windows (Win+I)': Shortcut(key: 'I', modifiers: ['WIN'], description: 'إعدادات Windows'),
    'تكبير النافذة (Win+Up)': Shortcut(key: 'UP', modifiers: ['WIN'], description: 'تكبير النافذة'),
    'تصغير النافذة (Win+Down)': Shortcut(key: 'DOWN', modifiers: ['WIN'], description: 'تصغير النافذة'),
    'نقل النافذة إلى اليسار (Win+Left)': Shortcut(key: 'LEFT', modifiers: ['WIN'], description: 'تثبيت النافذة يساراً'),
    'نقل النافذة إلى اليمين (Win+Right)': Shortcut(key: 'RIGHT', modifiers: ['WIN'], description: 'تثبيت النافذة يميناً'),
    'إغلاق النافذة (Alt+F4)': Shortcut(key: 'F4', modifiers: ['ALT'], description: 'إغلاق النافذة الحالية'),
    'قائمة النظام للنافذة (Alt+Space)': Shortcut(key: 'SPACE', modifiers: ['ALT'], description: 'قائمة النافذة'),
    'رجوع (Alt+Left)': Shortcut(key: 'LEFT', modifiers: ['ALT'], description: 'رجوع'),
    'تقدم (Alt+Right)': Shortcut(key: 'RIGHT', modifiers: ['ALT'], description: 'تقدم'),
    'تحديث الصفحة (F5)': Shortcut(key: 'F5', modifiers: [], description: 'تحديث'),
    'ملء الشاشة (F11)': Shortcut(key: 'F11', modifiers: [], description: 'ملء الشاشة'),
    'مساعدة (F1)': Shortcut(key: 'F1', modifiers: [], description: 'فتح المساعدة'),
  };
